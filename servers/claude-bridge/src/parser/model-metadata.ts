...
export const MODELS: ModelMetadata[] = [
	...
	},
	{
		...
		trainingDataCutoff: "2026-01",
		notes:
			"On Microsoft Foundry context is 200k. Default effort=high on Claude Code and API.",
	},
	{
		id: "claude-sonnet-5",
	...
	// ---- Legacy (still available) ----
	{
		...
		trainingDataCutoff: "2026-01",
		notes:
			"Tokenizer introduced here; ~30% more tokens per text vs. older models.",
	},
	{
		id: "claude-opus-4-6",
...
const MODEL_BY_ID: Record<string, ModelMetadata> = Object.fromEntries(
	MODELS.map((m) => [m.id, m]),
);
