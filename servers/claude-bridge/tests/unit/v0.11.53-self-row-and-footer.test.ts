...
import { peerAskTool, peerContextStatusTool, peerInboxReadTool } from "../../src/mcp/tools.ts";
...
async function context(name: string, source: "env" | "cwd-slug" = "env"): Promise<ServerContext> {
  return buildContext({
